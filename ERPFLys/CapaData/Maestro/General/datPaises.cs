    ...
    public class datPaises
    {
        public static DataTable ListaFormID()
        {
            ...
            using (SqlConnection Cnx = new SqlConnection(Configuracion.getCadConexion()))
            {
                Cmd.Connection = Cnx;
                Cmd.Connection.Open();
                Cmd.CommandText = tsqPaises.QR_ListaFormID();
        ...
        public static DataTable GetFormID(String Pais)
        {
            DataTable dt = new DataTable();
            SqlCommand Cmd = new SqlCommand();
            ...
            using (SqlConnection Cnx = new SqlConnection(Configuracion.getCadConexion()))
            {
                Cmd.Connection = Cnx;
                Cmd.Connection.Open();
                Cmd.CommandText = tsqPaises.QR_GetFormID();
                Cmd.CommandType = CommandType.StoredProcedure;
        ...
        public static DataTable ListaCombo(String Estado)
        {
            ...
            using (SqlConnection Cnx = new SqlConnection(Configuracion.getCadConexion()))
            {
                Cmd.Connection = Cnx;
                Cmd.Connection.Open();
                Cmd.CommandText = tsqPaises.QR_ListaCombo();
                Cmd.CommandType = CommandType.StoredProcedure;
                Cmd.Parameters.Add(new SqlParameter("@Accion", SqlDbType.VarChar)).Value = Constans.LISTA;
        ...
        public static DataTable ListaSearch(String Pais, String Descripcion, String Estado)
        {
            DataTable dt = new DataTable();
            SqlCommand Cmd = new SqlCommand();
            ...
            using (SqlConnection Cnx = new SqlConnection(Configuracion.getCadConexion()))
            {
                Cmd.Connection = Cnx;
                Cmd.Connection.Open();
                Cmd.CommandText = tsqPaises.QR_ListaSearch();
                Cmd.CommandType = CommandType.StoredProcedure;
                Cmd.Parameters.Add(new SqlParameter("@Accion", SqlDbType.VarChar)).Value = Constans.LISTA;
        ...
        public static entErrores MantFormID(entPaises Data)
        {
            ...
            using (SqlConnection Cnx = new SqlConnection(Configuracion.getCadConexion()))
            {
                ...
                try
                {
                    ...
                    Cmd.CommandText = tsqPaises.QR_MantFormID(Data.OperMantenimiento);
                    ...
                    {/**/
                        ...
                        else
                        {
                            ...
                            Cmd.Parameters.Add(new SqlParameter("@CodAduana", SqlDbType.VarChar)).Value = fnParmCmd.StrDBNull(Data.CodAduana, "");
                            Cmd.ExecuteNonQuery();
