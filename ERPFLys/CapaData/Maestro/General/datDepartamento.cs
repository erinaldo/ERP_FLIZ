    ...
    public class datDepartamento
    {
        public static DataTable ListaFormID()
        {
            ...
            using (SqlConnection Cnx = new SqlConnection(Configuracion.getCadConexion()))
            {
                Cmd.Connection = Cnx;
                Cmd.Connection.Open();
                Cmd.CommandText = tsqDepartamento.QR_ListaFormID();
        ...
        public static DataTable GetFormID(String Pais, String Departamento)
        {
            DataTable dt = new DataTable();
            SqlCommand Cmd = new SqlCommand();
            ...
            using (SqlConnection Cnx = new SqlConnection(Configuracion.getCadConexion()))
            {
                Cmd.Connection = Cnx;
                Cmd.Connection.Open();
                Cmd.CommandText = tsqDepartamento.QR_GetFormID();
                Cmd.CommandType = CommandType.StoredProcedure;
        ...
        public static DataTable ListaCombo(String Pais, String Estado)
        {
            DataTable dt = new DataTable();
            SqlCommand Cmd = new SqlCommand();
            ...
            using (SqlConnection Cnx = new SqlConnection(Configuracion.getCadConexion()))
            {
                Cmd.Connection = Cnx;
                Cmd.Connection.Open();
                Cmd.CommandText = tsqDepartamento.QR_ListaCombo();
                Cmd.CommandType = CommandType.StoredProcedure;
        ...
        public static DataTable ListaSearch(String Pais, String Departamento, String Descripcion, String Estado)
        {
            DataTable dt = new DataTable();
            SqlCommand Cmd = new SqlCommand();
            ...
            using (SqlConnection Cnx = new SqlConnection(Configuracion.getCadConexion()))
            {
                Cmd.Connection = Cnx;
                Cmd.Connection.Open();
                Cmd.CommandText = tsqDepartamento.QR_ListaSearch();
                Cmd.CommandType = CommandType.StoredProcedure;
        ...
        public static entErrores MantFormID(entDepartamento Data)
        {
            ...
            using (SqlConnection Cnx = new SqlConnection(Configuracion.getCadConexion()))
            {
                ...
                try
                {
                    ...
                    Cmd.CommandText = tsqDepartamento.QR_MantFormID(Data.OperMantenimiento);
                    ...
                    if (Data.OperMantenimiento == fnEnum.OperacionMant.Insertar || Data.OperMantenimiento == fnEnum.OperacionMant.Modificar)
                    {
                        ...
                        else if (fnEnum.OperacionMant.Modificar == fnEnum.OperacionMant.Modificar)
                        {
                        ...
                        Cmd.Parameters.Add(new SqlParameter("@CodigoDepFedd", SqlDbType.VarChar)).Value = fnParmCmd.StrDBNull(Data.CodigoDepFedd, "");
