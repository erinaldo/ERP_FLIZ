    ...
    public class datRubroGasto
    {
        public static DataTable ListaFormID()
        {
            ...
            using (SqlConnection Cnx = new SqlConnection(Configuracion.getCadConexion()))
            {
                Cmd.Connection = Cnx;
                Cmd.Connection.Open();
                Cmd.CommandText = tsqRubroGasto.QR_ListaFormID();
        ...
        public static DataTable GetFormID(String RubroGasto)
        {
            DataTable dt = new DataTable();
            SqlCommand Cmd = new SqlCommand();
            ...
            using (SqlConnection Cnx = new SqlConnection(Configuracion.getCadConexion()))
            {
                Cmd.Connection = Cnx;
                Cmd.Connection.Open();
                Cmd.CommandText = tsqRubroGasto.QR_GetFormID();
                Cmd.CommandType = CommandType.StoredProcedure;
                ...
                Cmd.Parameters.Add(new SqlParameter("@RubroGasto", SqlDbType.VarChar)).Value = RubroGasto;
        ...
        public static DataTable ListaCombo()
        {
            ...
            using (SqlConnection Cnx = new SqlConnection(Configuracion.getCadConexion()))
            {
                Cmd.Connection = Cnx;
                Cmd.Connection.Open();
                Cmd.CommandText = tsqRubroGasto.QR_ListaCombo();
                Cmd.CommandType = CommandType.StoredProcedure;
                SqlDataAdapter adapter = new SqlDataAdapter();
                adapter.SelectCommand = Cmd;
                adapter.SelectCommand.Parameters.AddWithValue("@Accion", Constans.LISTA);
        ...
        public static DataTable ListaSearch(String RubroGasto, String Descripcion)
        {
            DataTable dt = new DataTable();
            SqlCommand Cmd = new SqlCommand();
            ...
            using (SqlConnection Cnx = new SqlConnection(Configuracion.getCadConexion()))
            {
                Cmd.Connection = Cnx;
                Cmd.Connection.Open();
                Cmd.CommandText = tsqRubroGasto.QR_ListaSearch();
                Cmd.CommandType = CommandType.StoredProcedure;
                Cmd.Parameters.Add(new SqlParameter("@Accion", SqlDbType.VarChar)).Value = Constans.LISTA;
        ...
        public static entErrores MantFormID(entRubroGasto Data)
        {
            ...
            using (SqlConnection Cnx = new SqlConnection(Configuracion.getCadConexion())){
                ...
                try{
                    ...
                    Cmd.CommandText = tsqRubroGasto.QR_MantFormID(Data.OperMantenimiento);
                    ...
                    if (Data.OperMantenimiento == fnEnum.OperacionMant.Insertar || Data.OperMantenimiento == fnEnum.OperacionMant.Modificar)
                    {
                        ...
                        Cmd.Parameters.Add(new SqlParameter("@RubroGasto", SqlDbType.VarChar)).Value = Data.RubroGasto;
