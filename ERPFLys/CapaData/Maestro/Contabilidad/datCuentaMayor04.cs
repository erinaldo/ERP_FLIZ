    ...
    public class datCuentaMayor04
    {
        public static DataTable ListaFormID()
        {
            ...
            using (SqlConnection Cnx = new SqlConnection(Configuracion.getCadConexion()))
            {
                Cmd.Connection = Cnx;
                Cmd.Connection.Open();
                Cmd.CommandText = tsqCuentaMayor04.QR_ListaFormID();
        ...
        public static DataTable GetFormID(String CuentaMayor04)
        {
            DataTable dt = new DataTable();
            SqlCommand Cmd = new SqlCommand();
            ...
            using (SqlConnection Cnx = new SqlConnection(Configuracion.getCadConexion()))
            {
                Cmd.Connection = Cnx;
                Cmd.Connection.Open();
                Cmd.CommandText = tsqCuentaMayor04.QR_GetFormID();
                Cmd.CommandType = CommandType.StoredProcedure;
        ...
        public static DataTable ListaCombo(String CuentaMayor, String Estado)
        {
            DataTable dt = new DataTable();
            SqlCommand Cmd = new SqlCommand();
            ...
            using (SqlConnection Cnx = new SqlConnection(Configuracion.getCadConexion()))
            {
                Cmd.Connection = Cnx;
                Cmd.Connection.Open();
                Cmd.CommandText = tsqCuentaMayor04.QR_ListaCombo();
                Cmd.CommandType = CommandType.StoredProcedure;
                Cmd.Parameters.Add(new SqlParameter("@Accion", SqlDbType.VarChar)).Value = Constans.LISTA;
        ...
        public static DataTable ListaSearch(String CuentaMayor04, String CuentaMayor, String Descripcion, String Estado)
        {
            DataTable dt = new DataTable();
            SqlCommand Cmd = new SqlCommand();
            ...
            using (SqlConnection Cnx = new SqlConnection(Configuracion.getCadConexion()))
            {
                Cmd.Connection = Cnx;
                Cmd.Connection.Open();
                Cmd.CommandText = tsqCuentaMayor04.QR_ListaSearch();
                Cmd.CommandType = CommandType.StoredProcedure;
                Cmd.Parameters.Add(new SqlParameter("@Accion", SqlDbType.VarChar)).Value = Constans.LISTA;
        ...
        public static entErrores MantFormID(entCuentaMayor04 Data)
        {
            ...
            using (SqlConnection Cnx = new SqlConnection(Configuracion.getCadConexion()))
            {
                ...
                try
                {
                    ...
                    Cmd.CommandText = tsqCuentaMayor04.QR_MantFormID(Data.OperMantenimiento);
