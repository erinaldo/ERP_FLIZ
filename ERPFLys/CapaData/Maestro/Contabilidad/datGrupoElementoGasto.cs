...
{
    public class datGrupoElementoGasto
    {
        public static DataTable ListaFormID()
        {
            ...
            using (SqlConnection Cnx = new SqlConnection(Configuracion.getCadConexion()))
            {
                Cmd.Connection = Cnx;
                Cmd.Connection.Open();
                Cmd.CommandText = tsqGrupoElementoGasto.QR_ListaFormID();
        ...
        public static DataTable GetFormID(String Grupo)
        {
            DataTable dt = new DataTable();
            SqlCommand Cmd = new SqlCommand();
            ...
            using (SqlConnection Cnx = new SqlConnection(Configuracion.getCadConexion()))
            {
                Cmd.Connection = Cnx;
                Cmd.Connection.Open();
                Cmd.CommandText = tsqGrupoElementoGasto.QR_GetFormID();
                Cmd.CommandType = CommandType.StoredProcedure;
                ...
                Cmd.Parameters.Add(new SqlParameter("@Grupo", SqlDbType.VarChar)).Value = Grupo;
        ...
        public static DataTable ListaCombo(String Estado)
        {
            ...
            using (SqlConnection Cnx = new SqlConnection(Configuracion.getCadConexion()))
            {
                Cmd.Connection = Cnx;
                Cmd.Connection.Open();
                Cmd.CommandText = tsqGrupoElementoGasto.QR_ListaCombo();
                Cmd.CommandType = CommandType.StoredProcedure;
                Cmd.Parameters.Add(new SqlParameter("@Accion", SqlDbType.VarChar)).Value = Constans.LISTA;
        ...
        public static DataTable ListaSearch(String Grupo, String Descripcion, String Estado)
        {
            DataTable dt = new DataTable();
            SqlCommand Cmd = new SqlCommand();
            ...
            using (SqlConnection Cnx = new SqlConnection(Configuracion.getCadConexion()))
            {
                Cmd.Connection = Cnx;
                Cmd.Connection.Open();
                Cmd.CommandText = tsqGrupoElementoGasto.QR_ListaSearch();
                Cmd.CommandType = CommandType.StoredProcedure;
                Cmd.Parameters.Add(new SqlParameter("@Accion", SqlDbType.VarChar)).Value = Constans.LISTA;
        ...
        public static entErrores MantFormID(entGrupoElementoGasto Data)
        {
            ...
            using (SqlConnection Cnx = new SqlConnection(Configuracion.getCadConexion())){
                ...
                try{
                    ...
                    Cmd.CommandText = tsqGrupoElementoGasto.QR_MantFormID(Data.OperMantenimiento);
