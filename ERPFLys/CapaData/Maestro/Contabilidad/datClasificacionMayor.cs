...
{
    public class datClasificacionMayor
    {
        public const string sProc = "UP_MANT_CLASIFICACION_MAYOR";
        ...
        public static DataTable GetFormID(String Clasificacion)
        {
            DataTable dt = new DataTable();
            SqlCommand Cmd = new SqlCommand();
        ...
        public static DataTable ListaSearch(String Clasificacion, String Descripcion, String Estado)
        {
            DataTable dt = new DataTable();
            SqlCommand Cmd = new SqlCommand();
