...
{
    public class datTipoCuentaBalComp
    {
        public static DataTable ListaFormID()
        {
            ...
            using (SqlConnection Cnx = new SqlConnection(Configuracion.getCadConexion()))
            {
                Cmd.Connection = Cnx;
                Cmd.Connection.Open();
                Cmd.CommandText = tsqTipoCuentaBalComp.QR_ListaFormID();
        ...
        public static DataTable GetFormID(String TipoCuenta)
        {
            DataTable dt = new DataTable();
            SqlCommand Cmd = new SqlCommand();
            ...
            using (SqlConnection Cnx = new SqlConnection(Configuracion.getCadConexion()))
            {
                Cmd.Connection = Cnx;
                Cmd.Connection.Open();
                Cmd.CommandText = tsqTipoCuentaBalComp.QR_GetFormID();
                Cmd.CommandType = CommandType.StoredProcedure;
                ...
                Cmd.Parameters.Add(new SqlParameter("@TipoCuenta", SqlDbType.VarChar)).Value = TipoCuenta;
        ...
        public static DataTable ListaCombo(String Estado)
        {
            ...
            using (SqlConnection Cnx = new SqlConnection(Configuracion.getCadConexion()))
            {
                Cmd.Connection = Cnx;
                Cmd.Connection.Open();
                Cmd.CommandText = tsqTipoCuentaBalComp.QR_ListaCombo();
        ...
        public static DataTable ListaSearch(String TipoCuenta, String Descripcion, String Estado)
        {
            DataTable dt = new DataTable();
            SqlCommand Cmd = new SqlCommand();
            ...
            using (SqlConnection Cnx = new SqlConnection(Configuracion.getCadConexion()))
            {
                Cmd.Connection = Cnx;
                Cmd.Connection.Open();
                Cmd.CommandText = tsqTipoCuentaBalComp.QR_ListaSearch();
                Cmd.CommandType = CommandType.StoredProcedure;
                Cmd.Parameters.Add(new SqlParameter("@Accion", SqlDbType.VarChar)).Value = Constans.LISTA;
        ...
        public static entErrores MantFormID(entTipoCuentaBalComp Data)
        {
            ...
            using (SqlConnection Cnx = new SqlConnection(Configuracion.getCadConexion()))
            {
                ...
                try
                {
                    ...
                    Cmd.CommandText = tsqTipoCuentaBalComp.QR_MantFormID(Data.OperMantenimiento);
