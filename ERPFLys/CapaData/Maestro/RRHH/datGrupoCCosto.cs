    ...
    public class datGrupoCCosto
    {
        public static DataTable ListaFormID()
        {
            ...
            using (SqlConnection Cnx = new SqlConnection(Configuracion.getCadConexion()))
            {
                Cmd.Connection = Cnx;
                Cmd.Connection.Open();
                Cmd.CommandText = tsqGrupoCCosto.QR_ListaFormID();
        ...
        public static DataTable GetFormID(String Compania, String Grupo)
        {
            DataTable dt = new DataTable();
            SqlCommand Cmd = new SqlCommand();
            ...
            using (SqlConnection Cnx = new SqlConnection(Configuracion.getCadConexion()))
            {
                Cmd.Connection = Cnx;
                Cmd.Connection.Open();
                Cmd.CommandText = tsqGrupoCCosto.QR_GetFormID();
                Cmd.CommandType = CommandType.Text;
                Cmd.Parameters.Add(new SqlParameter("@Compania", SqlDbType.VarChar)).Value = Compania;
                Cmd.Parameters.Add(new SqlParameter("@GrupoCC", SqlDbType.VarChar)).Value = Grupo;
        ...
        public static DataTable ListaCombo(String Compania, String Estado)
        {
            ...
            using (SqlConnection Cnx = new SqlConnection(Configuracion.getCadConexion()))
            {
                Cmd.Connection = Cnx;
                Cmd.Connection.Open();
                Cmd.CommandText = tsqGrupoCCosto.QR_ListaCombo();
                Cmd.CommandType = CommandType.Text;
                Cmd.Parameters.Add(new SqlParameter("@Compania", SqlDbType.VarChar)).Value = Compania;
        ...
        public static DataTable ListaSearch(String Compania, String Grupo, String Descripcion, String Estado)
        {
            DataTable dt = new DataTable();
            SqlCommand Cmd = new SqlCommand();
            ...
            using (SqlConnection Cnx = new SqlConnection(Configuracion.getCadConexion()))
            {
                Cmd.Connection = Cnx;
                Cmd.Connection.Open();
                Cmd.CommandText = tsqGrupoCCosto.QR_ListaSearch();
                Cmd.CommandType = CommandType.Text;
                Cmd.Parameters.Add(new SqlParameter("@Compania", SqlDbType.VarChar)).Value = Compania;
                Cmd.Parameters.Add(new SqlParameter("@GrupoCC", SqlDbType.VarChar)).Value = Grupo;
        ...
        public static entErrores MantFormID(entGrupoCCosto Data)
        {
            ...
            using (SqlConnection Cnx = new SqlConnection(Configuracion.getCadConexion())){
                ...
                try{
                    ...
                    Cmd.CommandText = tsqGrupoCCosto.QR_MantFormID(Data.OperMantenimiento);
                    ...
                    switch (Data.OperMantenimiento){
                        ...
                        case fnEnum.OperacionMant.Modificar:
                            ...
                            Cmd.Parameters.Add(new SqlParameter("@GrupoCC", SqlDbType.VarChar)).Value = Data.GrupoCC;
