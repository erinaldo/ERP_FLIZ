...
namespace FiltroLys.Repository.Maestro.Tesoreria
{
    ...
    {
        public  const  string sProc = "UP_MANT_TIPO_PAGO";
        ...
        public static DataTable GetFormID(String TipoPago)
        {
            DataTable dt = new DataTable();
            SqlCommand Cmd = new SqlCommand();
        ...
        public static DataTable ListaCombo(String FlagSistema, String Estado)
        {
            DataTable dt = new DataTable();
            SqlCommand Cmd = new SqlCommand();
        ...
        public static DataTable ListaSearch(String TipoPago, String FlagSistema, String Descripcion, String Estado)
        {
            DataTable dt = new DataTable();
            SqlCommand Cmd = new SqlCommand();
