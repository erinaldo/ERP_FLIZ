...
{
    public class tsqCorrelativoVoucher
    {
        static String xsql = "";

        public static String QR_ListaFormID()
        {
            xsql = "UP_MANT_CORRELATIVO_VOUCHER";
            return xsql;
        }
        ...
        public static String UP_GetUltimoCorrelativo()
        {
            xsql = "SP_CB_GETULTIMOCORRELATIVO";
            return xsql;
        }

        public static String UP_SetUltimoCorrelativo(){
            xsql = "SP_CB_SETULTIMOCORRELATIVO";
            return xsql;
        }
