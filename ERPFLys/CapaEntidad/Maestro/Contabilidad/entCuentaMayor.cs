...
{
    public class entCuentaMayor : entBase
    {
        private String c_CuentaMayor, c_Clasificacion, c_TipoCuenta, c_Descripcion, c_Estado, c_UltimoUsuarioMod, c_DescripcionAnt;
        private DateTime d_UltimaFechaMod;
        private String c_TipoCuentaNombre,c_UserNombreForm;
        ...
        {
            get { return c_TipoCuentaNombre; }
            set { c_TipoCuentaNombre = value; }
        }
